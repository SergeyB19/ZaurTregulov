...
class TestEmployee {
    ...
    public static void main(String[] args) {
        ...
        testEmployee.filtraciyaRabotnikov(arrayList, (Employee em)->{return em.department=="IT" && em.salary>200;});
        System.out.println("__________________________________");
        testEmployee.filtraciyaRabotnikov(arrayList, (Employee em)->{return  em.name.startsWith("E")&& em.salary!=450;} );
        System.out.println("__________________________________");
        testEmployee.filtraciyaRabotnikov(arrayList, (Employee em)->{return  em.name.equals(em.department);});
